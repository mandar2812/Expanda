...
def _process_hf_smolinstruct(
    ...
    with open(output_file, "a", encoding="utf-8") as f:
        for conv in tqdm(
            dataset, total=len(dataset), desc="Processing SMolInstruct"
        ):
            text: str = ""
...
__extension__ = {
    "name": "SMolInstruct dataset processor",
    "version": "1.0",
    "description": "Process the osunlp/SMolInstruct dataset.",
    "author": "mandar2812",
    "main": _process_hf_smolinstruct,
    "arguments": {
